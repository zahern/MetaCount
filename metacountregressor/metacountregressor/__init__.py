...
_EXPORTS = {
    ...
    "fit_cluster_ar2": ("pavement_clr", "fit_cluster_ar2"),
    "fit_cluster_random_walk": ("pavement_clr", "fit_cluster_random_walk"),
    "fit_cluster_nur": ("pavement_clr", "fit_cluster_nur"),
    "TemporalRandomParameterFit": ("temporal_models", "TemporalRandomParameterFit"),
    "TemporalRandomParameterRegressor": ("temporal_models", "TemporalRandomParameterRegressor"),
    "fit_temporal_random_parameter_model": ("temporal_models", "fit_temporal_random_parameter_model"),
    "temporal_covariance": ("temporal_models", "temporal_covariance"),
