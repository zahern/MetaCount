...
class ModelConstraints:
    ...
    def to_evaluator_kwargs(self) -> dict:
        ...
        - Variable is *pure membership* (only roles in {0, 7, 8}):
          -> ``membership_override``
        - Variable has any outcome role (1-6), possibly also membership roles:
        ...
        for var, role_set in self._roles.items():
            ...
            # Roles 1-6 are actual outcome-equation roles.
            # Role 0 = excluded, roles 7-8 = membership only.
            ...
            if has_outcome_role:
                ...
                # Pure membership/excluded variable (subsets of {0, 7, 8})
